...
class InterpolationEngine(object):
    ...
    This class is an abstract base class; its descendants perform the
    actual work.
...
class Section(dict):
    ...
    def __setitem__(self, key, value, unrepr=False):
        ...
        if isinstance(value, Section):
            ...
            dict.__setitem__(
                self,
                key,
                Section(self, new_depth, self.main, indict=value, name=key),
            )
        else:
            if key not in self:
    ...
    def clear(self):
        """A version of clear that also affects scalars/sections Also clears
        comments and configspec.
    ...
    def as_bool(self, key):
        ...
        The corresponding value must be a string or
    ...
    def as_int(self, key):
        """A convenience method which coerces the specified value to an
                integer.
...
class ConfigObj(Section):
    ...
    def _handle_error(self, text, ErrorClass, infile, cur_index):
        ...
        Either raise the error or store it. The error will have occurred
        at ``cur_index``
    ...
    def _set_configspec(self, section, copy):
        ...
        Handles setting the configspec on subsections including sections
        to be validated by __many__
    ...
    def validate(self, validator, preserve_errors=False, copy=False, section=None):
        ...
        def validate_entry(entry, spec, val, missing, ret_true, ret_false):
            ...
            try:
                ...
                # No default, bad default or validator has no
                # 'get_default_value'.
                pass
    ...
    def reload(self):
        ...
        This method raises a ``ReloadError`` if the ConfigObj doesn't
        have a filename attribute pointing to a file.
...
def get_extra_values(conf, _prepend=()):
    ...
    subsection of the 'foo' section the first member will be ``('foo',
    'bar')``.
