...
# TODO: Requires work, once Philip "okays" the xml output.
...
class _TestInfo(object):
    ...
    def print_report(self, stream):
        ...
        stream.write(
            ...
            + 'time="%(time).4f">' % {"class": self._class, "method": self._method, "time": self._time}
        )
    ...
    def _print_error(self, stream, tagname, error):
        ...
        raise ValueError("escape is deemed unsafe, so it has been commented out. Uncomment at your own risk if you need this to work.")
...
class XMLTestRunner(object):
    ...
    path = property(
        ...
        """The path where the XML files are stored.
                    ...
                    This property is ignored when the XML file is written to
                    a file stream.""",
    )
